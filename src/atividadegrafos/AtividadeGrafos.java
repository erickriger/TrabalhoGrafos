...
public class AtividadeGrafos {
    ...
    public static void menu() {
        ...
        do {
            ...
            System.out.println("6. Determinar a classe do grafo (completo, ciclo, caminho, k-regular)");
            System.out.println("7. Determinar o centro do grafo, se ele for uma árvore");
